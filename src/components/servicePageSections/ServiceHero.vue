<template>
  <div>
    ...
    <!-- service section -->
    <h1 class="text-headingclr text-4xl font-bold font-bevietnam text-center mt-20">
      Our Services
    </h1>
    <p class="font-bevietnam text-center max-w-[1200px] px-2 mx-auto mt-4 font-normal text-lg text-textcolor">
    ...
    <div class="max-w-[1200px] mx-auto">
      <div class="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-5 mt-20 px-2">
        <div v-for="card in servises" :key="card.icon" class="bg-white rounded-xl p-3 shadow-xl">
          <div class="px-3 py-2">
          ...
          <div class="flex justify-between mt-4 mb-2">
            <h3 class="text-cardheadingclr font-bevietnam font-bold text-xl">
              {{ card.priceTitle }}
            </h3>
            <p class="text-[#D90A06] font-bevietnam font-bold text-xl">
              {{ card.price }}
            </p>
          </div>
        </div>
